...
const Section4 = () => {
    ...
    <div className='absolute inset-0 bg-[url(https://i.ibb.co/ChkDtDc/360-F-86561234-8-HJdzg2i-Bl-Pap18-K38mbyet-Kfdw1o-Nrm.jpg)] bg-cover bg-fixed bg-center'></div>
    ...
    <div className='flex flex-col gap-8 md:flex-row justify-center items-center relative z-10'>
            ...
            <div className='flex flex-col'>
                <h2 className='font-medium text-gray-200 lg:text-lg text-sm'>Trendy Collection's</h2>
                <h1 className='text-gray-100 lg:text-5xl md:text-4xl text-3xl '>HIGHEST QUALITY COLLECTION</h1>
            ...
            <div>
                <img className='lg:max-w-[390px] md:max-w-[330px] max-w-[200px]' src="https://i.ibb.co/k50Zgg9/ff5cae90f5a04424a361c9e12a0152eb-removebg-preview.png" alt="" />
            </div>
        </div>
    </Container>
</div>
